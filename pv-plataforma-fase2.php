        ...
        (function(window, location) {
            ...
            window.addEventListener("popstate", function() {
                if (location.hash === "#!/backbutton") {
                    ...
                    setTimeout(function() {
                        location.replace("pos-plataforma-fase2.php");
                    }, 0);
                }
            }, false);
        }(window, location));
...
<body>
    ...
    <a href="https://wa.me/5521978926228?text=OI+Karla%2C+quero+mais+informa%C3%A7%C3%B5es+sobre+a+FASE+2+%21%21" class="floating white">
    ...
    <div class="container center main-container">
        <iframe class="mb1" src="https://www.youtube.com/embed/Ss9jB_Hp7_U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <a href="pos-plataforma-fase2.php" class="b z-depth-3 red">
            INSCRIÇÃO PSG TURBO
        </a><br />
        <p class="white p1 black-text" style="font-size:12pt;">
            PROGRAMA DE TRANSFORMAÇÃO CORPORAL com Protocolo Alimentar Calculado onde <b>vai aprender a combinar 317 alimentos simples e acessíveis</b>, para reduzir drasticamente a gordura, com todas as refeições planejadas, facilitando a vida de quem não tem tempo.<br />
            <br />
            ...
            Terá acesso ao Grupo VIP e Suporte Individual de um especialista da Equipe do Plano Seca Gordura para <strong>acompanhar sua rotina alimentar e emocional.</strong>
            <br />
        ...
        <div class="d">
            <p>
                <b>ACESSO PSG TURBO<br /></b><br />
                VOCÊ TEM A OPORTUNIDADE de escolher o tempo de acesso à plataforma do Plano Seca Gordura Turbo e assim conhecer as estratégias usadas com as alunas.
            </p>
        </div>
        ...
        <div class="d">
            <p>
                ...
                Durante o tempo escolhido, terá acesso a planejamentos de acordo com seu objetivo: redução de gordura, ganho de massa, manutenção, flacidez e menopausa.
            </p>
        </div>
        ...
        <div class="d d2">
            ...
            <p>
                Meu nome é Nair e aos 82 anos eu achava que seria difícil, mas depois que aumentei a ingestão nutricional no PSG TURBO e as combinações adequadas, não tive nenhuma dificuldade.
            </p>
        </div>
        <div class="d d2">
            <div class="img-container">
        ...
        <div class="d d2">
            ...
            <p>
                Meu nome é Deisy e como moro no Sul, achava que o frio dava mais fome, só que depois que entrei no PSG TURBO, consegui emagrecer mesmo no frio e no meio da pandemia. Nunca conheci um programa com uma equipe tão dedicada. </p>
        </div>
        ...
        <div class="d d2">
            ...
            <p>
                Sou a Marluci e aos 54 anos, estou na melhor fase da minha vida depois que conheci o Plano Seca Gordura Turbo. Além do resultado, tenho acompanhamento e motivação para continuar. Aprender a se amar faz diferença nas escolhas
        </div>
