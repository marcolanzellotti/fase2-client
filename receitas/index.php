...
<body>
    ...
    <div class="container center main-container">
        <form action="/receitas" method="GET" id="search-form">
            <div class="row search-row">
                ...
                <div class="col s12 input-field">
                    ...
                    <select id="selectCat" required="false">
        ...
        <div class="recipes">
            ...
            $query = ("SELECT r.title, r.id, r.create_date, c.name, r.content, r.cat, r.cover FROM recipes_bkp r LEFT JOIN recipes_cats c ON r.cat=c.id WHERE 1 $completion $searchCompletion LIMIT 40");
