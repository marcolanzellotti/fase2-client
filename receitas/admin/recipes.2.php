...
<body>
    ...
    <div class="container center main-container">
        ...
        <div class="recipes">
            ...
            $query = "SELECT r.title, r.id, r.create_date, c.name, r.content, r.cover FROM recipes_bkp r LEFT JOIN recipes_cats c ON r.cat=c.id  WHERE 1 $completion $searchCompletion";
            ...
            ?>
                <a class="recipe" href="edit-recipe.2.php?id=<?= $recipe['id'] ?>">
