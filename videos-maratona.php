...
<body>
    <header style="background-image:url(http://fase2.planosecagordura.com.br/assets/img/livemaratona.png);background-size:cover;">
    ...
    <div class="container center main-container" style="width:100%">
        <div class="section home-section" style="width: 100%;">
            <?php
            $qLives = Q("SELECT * FROM lives WHERE cat=1 ORDER BY id DESC");
